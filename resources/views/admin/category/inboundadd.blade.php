...
<div class="panel panel-default" style="color: #262626;">
    <div class="panel-body">
        ...
        <form method="POST" action="{{ url('creatInfo') }}">
                        @csrf
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-5">
      <input type="text" class="form-control" id="inputEmail3" value="{{ Auth::user()->name }}" name="username" required>
    </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-5">
      <input type="number" class="form-control" id="inputEmail3" placeholder="Card Number" name="cardNumber" required>
    </div>
   ...
   <div class="form-group row">
    ...
    <div class="col-sm-5">
      <input type="number" class="form-control" id="inputEmail3" placeholder="Contact number" name="contuctNumber" required>
    </div>
...
" class="Visa  Debit Card" style="display: none;">Capture Card Delivery Request
  ...
  <div class="col-sm-5">
   ...
   <div class="form-group row">
    ...
    <div class="col-sm-8">
      <textarea class="form-control" rows="5"  name="categorydes" notrequired></textarea>
    </div>
